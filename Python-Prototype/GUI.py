...
fitEnter = Entry(root)
fitEnter.grid(row=0, column=1, ipadx=15, ipady=10)
...
unfitEnter.grid(row=1, column=1, ipadx=15, ipady=10)
...
candEnter.grid(row=2, column=1, ipadx=15, ipady=10)
...
caniEnter.grid(row=3, column=1, ipadx=15, ipady=10)
...
pressEnter.grid(row=4, column=1, ipadx=15, ipady=10)
...
floodEnter.grid(row=0, column=3, ipadx=15, ipady=10)
...
tempEnter.grid(row=1, column=3, ipadx=15, ipady=10)
...
oxEnter = Entry(root)
oxEnter.grid(row=2, column=3, ipadx=15, ipady=10)
...
coEnter = Entry(root)
coEnter.grid(row=3, column=3, ipadx=15, ipady=10)
coEnter.config(font=('Fixedsys', 10))
eabsEnter = Entry(root)
eabsEnter.grid(row=4, column=3, ipadx=15, ipady=10)
...
def enterClick():
    ...
    if eabs==(fitSurv+unfitSurv):
        ...
        eabSETLabel = Label(root, text="EABs start escape time: N/A").grid(row=10, column=0)
...
enterButt.grid(row=5, column=1, pady=10)
