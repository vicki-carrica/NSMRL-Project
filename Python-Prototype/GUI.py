...
unfitEnter = Entry(root, width=10)
...
pressEnter = Entry(root, width=10)
...
floodEnter = Entry(root, width=10)
...
enterButt = Button(root, text="Enter", fg="purple", command=enterClick, padx=20, pady=10)
enterButt.grid(row=6, column=1, pady=10)
enterButt.config(font=('Fixedsys', 10), bg='white')
plotDataButt = Button(root, text="Plot Data", fg="purple", padx=20, pady=10)
