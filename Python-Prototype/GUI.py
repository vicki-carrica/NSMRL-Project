...
fitEnter = Entry(root)
fitEnter.grid(row=1, column=1, ipadx=10, ipady=10, pady=5)
...
unfitEnter.grid(row=2, column=1, ipadx=10, ipady=10, pady=5)
...
candEnter.grid(row=3, column=1, ipadx=10, ipady=10, pady=5)
...
caniEnter.grid(row=4, column=1, ipadx=10, ipady=10, pady=5)
...
pressEnter.grid(row=5, column=1, ipadx=10, ipady=10, pady=5)
...
floodEnter.grid(row=1, column=3, ipadx=10, ipady=10, pady=5)
...
tempEnter.grid(row=2, column=3, ipadx=10, ipady=10, pady=5)
tempEnter.config(font=('Fixedsys', 10))
oxLabel = Label(root, text="Oxygen (%SEV): ")
oxLabel.grid(row=3, column=2)
oxLabel.config(font=('Fixedsys', 15))
oxEnter = Entry(root)
oxEnter.grid(row=3, column=3, ipadx=10, ipady=10, pady=5)
...
coEnter = Entry(root)
coEnter.grid(row=4, column=3, ipadx=10, ipady=10, pady=5)
coEnter.config(font=('Fixedsys', 10))
eabsEnter = Entry(root)
eabsEnter.grid(row=5, column=3, ipadx=10, ipady=10, pady=5)
eabsEnter.config(font=('Fixedsys', 10))
eabsLabel = Label(root, text="Survivors with EABs: ")
eabsLabel.grid(row=5, column=2)
eabsLabel.config(font=('Fixedsys', 15))
oSTLabel = Label(root, text=" ")
oSTLabel.grid(row=7, column=0, columnspan=2)
oSTLabel.config(font=('Fixedsys', 1))
coSTLabel = Label(root, text=" ")
coSTLabel.config(font=('Fixedsys', 1))
coSTLabel.grid(row=8, column=0, columnspan=2)
oSETLabel = Label(root, text=" ")
oSETLabel.grid(row=9, column=0, columnspan=2)
oSETLabel.config(font=('Fixedsys', 1))
coSETLabel = Label(root, text=" ")
coSETLabel.grid(row=7, column=2, columnspan=2)
coSETLabel.config(font=('Fixedsys', 1))
eabSETLabel = Label(root, text=" ")
eabSETLabel.grid(row=8, column=2, columnspan=2)
eabSETLabel.config(font=('Fixedsys', 1))
...
enterButt = Button(root, text="Enter", fg="purple", command=enterClick, padx=25, pady=10)
enterButt.grid(row=6, column=1, pady=10)
enterButt.config(font=('Fixedsys', 10), bg='white')
plotDataButt = Button(root, text="Plot Data", fg="purple", padx=25, pady=10)
